...
enum HealthBenefit: String, CaseIterable {
    case heartRate = "Heart rate normalizes"
    case bloodPressure = "Blood pressure lowers"
    case oxygenLevel = "Oxygen levels improve"
    case nicotineLevel = "Nicotine levels return to zero"
    case carbonMonoxide = "Carbon monoxide levels drop"
    case mucus = "Clearing out mucus"
    case smellAndTaste = "Smell and taste better"
    case breathing = "Breathing gets easier"
    case circulation = "Circulation improvement"
    case lungFunction = "Better lung function"
    case coughing = "Coughing decreases"
    case cardiovascularSystem = "Heart disease risk decreases"
    case stroke = "Stroke risk decreases"
    case mouthAndThroatCancer = "Reduced risk of\nmouth and throat cancer"
    case bladderAndKidneyCancer = "Reduced risk of\nbladder and kidney cancer"
    case lungCancer = "Decreased risk of lung cancer"
    case heartDisease = "Heart disease risk equals\nthat of a non-smoker"
